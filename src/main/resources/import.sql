...
insert into product (id, name, version, release_date, company, category_id, price, description) values (-12, 'avast! Pro Antivirus', '2014', {ts '2014-02-13'}, 'avast', -2, 30790, 'Avast security software products are developed for Microsoft Windows, Mac OS X, Android and Linux users by AVAST Software s.r.o., a Czech private limited company.');
