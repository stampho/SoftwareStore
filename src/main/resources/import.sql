...
insert into user (id, email, name, password, real_name, registration_date, role) values (-3, 'gary@gmail.com', 'gary', 'gary', 'Gary Elmore', {ts '2014-12-03 08:00:59.72'}, 0);
insert into user (id, email, name, password, real_name, registration_date, role) values (-4, 'simmons@mail.com', 'carlos', 'carlos', 'Carlos Simmons', {ts '2014-08-08 12:03:02.00'}, 0);
